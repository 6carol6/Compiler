...
{
       0,    43,    43,    49,    53,    55,    59,    63,    68,    72,
      78,    82,    87,    91,    96,   101,   103,   109,   113,   118,
     122,   127,   131,   136,   142,   147,   151,   153,   157,   161,
     165,   169,   173,   179,   183,   185,   190,   194,   199,   203,
     209,   213,   217,   221,   225,   229,   233,   237,   241,   245,
     249,   253,   257,   261,   265,   269,   273,   277,   282,   286
};
#endif
...
#line 96 "syntax.y"
    {
				...
				connect_tree(&(yyval.treeNode), 1, (yyvsp[(1) - (1)].treeNode));
				printf("HEHEHEHE1%s",(yyvsp[(1) - (1)].treeNode)->subname);
			;}
    break;
...
#line 103 "syntax.y"
    {
				...
				connect_tree(&(yyval.treeNode), 1, (yyvsp[(1) - (1)].treeNode));printf("HEHEHEHE2%s",(yyvsp[(1) - (1)].treeNode)->subname);
			;}
    break;
...
#line 109 "syntax.y"
    {
				...
				connect_tree(&(yyval.treeNode), 1, (yyvsp[(1) - (1)].treeNode));printf("HEHEHEHE3%s",(yyvsp[(1) - (1)].treeNode)->subname);
			;}
    break;
...
#line 122 "syntax.y"
    {
				create_tree_node(&(yyval.treeNode), "FunDec", "", 1);
				connect_tree(&(yyval.treeNode), 3, (yyvsp[(1) - (3)].treeNode), (yyvsp[(2) - (3)].treeNode), (yyvsp[(3) - (3)].treeNode));printf("HEHEHEHE4%s\n",(yyval.treeNode)->subname);
			;}
    break;
